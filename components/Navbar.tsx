    ...
    <header className="w-full fixed top-0 z-50 bg-[#0d0e15]/90 backdrop-blur-md border-b border-gray-800">
      ...
      <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-6 text-sm font-medium text-gray-300">
          ...
          <Link href="/gom-plaza" className="hover:text-white">GOM Plaza</Link>
          <Link href="/card-lab" className="hover:text-white">Card Lab</Link>
          <Link href="/orders" className="hover:text-white">Lịch Sử Đơn</Link>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <Link href="/admin" className="bg-amber-500 text-black px-3 py-1 rounded text-xs font-bold hover:bg-amber-400">
            Admin
          </Link>
        </div>
      </div>
